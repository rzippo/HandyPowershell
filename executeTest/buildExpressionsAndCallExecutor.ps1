...
$executionTarget = "E:\Users\Raffaele\Documents\GitHub\HandyPowershell\executeTest\executionTarget.ps1";
$numFiles = 30;
$nPar = 5;
$sleepTime = 3;
...
E:\Users\Raffaele\Documents\GitHub\HandyPowershell\executeExpressions.ps1 -nParallelJobs $nPar -expressions $expressions;